...
(define (lookup-key k)
  (assoc (first (string->list k)) keymap))
...
(define (wkfun n w) (drawkey "white" n w))

(define (bkfun n w) (drawkey "black" n w))
...
(define (key-outlines w) (place-image (beside (rectangle wkeylen wkeywid "outline" "black")
                                              ...
                                              (rectangle wkeylen wkeywid "outline" "black")
                                              (rectangle wkeylen wkeywid "outline" "black"))
                                      (/ len 2) wkey-y-pos (rectangle len wid "outline" box-color)))
